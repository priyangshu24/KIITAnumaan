...
export default function PlaygroundSolvePage() {
  // The IDE is a fixed full-viewport surface with its own internal scrolling —
  // lock the document so no page-level scrollbar appears behind it.
  useEffect(() => {
