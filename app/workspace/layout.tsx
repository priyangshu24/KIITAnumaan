...
import WorkspaceSidebarSlot from '@/components/workspace/WorkspaceSidebarSlot'
import WorkspaceNavbarSlot from '@/components/workspace/WorkspaceNavbarSlot'
import FloatingAIAssistantSlot from '@/components/workspace/FloatingAIAssistantSlot'
...
export default function WorkspaceLayout({
  ...
  return (
    <div className="min-h-screen bg-[#080808] text-white flex overflow-x-hidden selection:bg-[#FF3B30] selection:text-white relative">
      ...
      {/* Floating Fixed Sidebar (+ layout spacer) wrapped in Suspense.
          Hidden on full-bleed routes like the Playground IDE. */}
      ...
      {/* Floating AI Assistant in Bottom Right Corner (hidden on full-bleed routes) */}
      <Suspense fallback={null}>
        <FloatingAIAssistantSlot />
      </Suspense>
    </div>
  )
}
